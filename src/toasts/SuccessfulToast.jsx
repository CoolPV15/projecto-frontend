export default function SuccessfulToast({mssg1,mssg2,onClose}) {
    return (
        <div className="bg-white inline-flex space-x-3 p-3 text-sm rounded border border-gray-200">
            ...
            <div>
                <h3 className="text-slate-700 font-medium">{mssg1}</h3>
                <p className="text-slate-500">{mssg2}</p>
            </div>
            <button type="button" onClick={onClose} aria-label="close" className="cursor-pointer mb-auto text-slate-400 hover:text-slate-600 active:scale-95 transition">
